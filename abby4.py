...
def predict_language(text):
    ...
    google_lang_code = language_code_map.get(label, 'en')  
...
def recognize_and_detect_language():
    ...
    try:
        ...
        # st.write(f"{detected_language_code}")
...
st.markdown("Chat with Abby to retrieve information about Absa.")
...
if not st.session_state.messages:
    st.session_state.messages.append({"role": "bot", "text": "Hello! I'm Abby, a multilingual chatbot here to assist you with information about Absa. You are welcome to chat with me in any language. How can I help you today?", "key": "initial_bot_message"})
